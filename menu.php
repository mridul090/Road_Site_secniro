...
<div id="mmenu">
	...
	<li>
		...
		<ul>
	        <li><a href="db_student_login.php">Student</a></li>
			<li><a href="db_teacher_login.php">Teacher</a></li>
		</ul>
	</li>
	<li><a href=" ######### ">Booking Info</a>
		<ul>
			<li><a href="student_booked.php ">Student</a></li>
		</ul>
	</li>
	<li>
		<a href=" ######### ">Chat Info</a>
...
<div id="mmenu">
    ...
    <li>
                            <a href=" ######### ">Subject</a>
                             <ul>
                                <li><a href="bangla.php">Bangla</a></li>
    ...
    <li>
        <a href="db_teacher_signup.php">Teacher Info</a>
    </li>
    <li>
        <a href="ordered.php">Booked Info</a>
    </li>
    <li>
        <a href="confirmedList.php">Confirmed List</a>
    </li>
...
<div id="mmenu">
	<li>
        <a href="teacheraccount.php">Home</a>
    </li>
    <li>
        <a href="teacherinfo.php">profile</a>
    </li>
    <li>
        <a href="bookedinfo.php">Booked Info</a>
    </li>
	<li><a href="logout.php">Log Out</a></li>
</div>
